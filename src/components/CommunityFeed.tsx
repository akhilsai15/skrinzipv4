        ...
        {showComments && (
          ...
          >
            <div className="bg-[#111115] rounded-xl border border-white/5 p-3 flex flex-col gap-4">
              ...
              <div className="flex gap-3">
                ...
                <div className="flex flex-col gap-1 w-full">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] text-[#888899]">45m</span>
                  </div>
                  ...
                  <div className="flex items-center gap-3 mt-1">
                    <span className="text-[11px] font-bold text-[#888899] hover:text-white flex items-center gap-1 cursor-pointer transition-colors">
                      <Zap className="w-3 h-3 hover:text-yellow-400" /> 3
                    </span>
              ...
              <div className="flex gap-3">
                <div className="w-7 h-7 rounded-full bg-[#302020] flex shrink-0 items-center justify-center text-[9px] font-bold text-white shadow-sm">
                  P
                </div>
                <div className="flex flex-col gap-1 w-full">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] text-[#888899]">1h</span>
                  </div>
                  <p className="text-[13px] text-white/90 leading-tight">
                    Saturday works for me perfectly!
                  </p>
                  <div className="flex items-center gap-3 mt-1">
                    <span className="text-[11px] font-bold text-[#888899] hover:text-white flex items-center gap-1 cursor-pointer transition-colors">
                      <Zap className="w-3 h-3 hover:text-yellow-400" /> 7
                    </span>
                    <span className="text-[11px] font-bold text-[#888899] hover:text-white cursor-pointer transition-colors">
                      Reply
                    </span>
              ...
              <button className="text-[11px] font-bold text-[#888899] text-left hover:text-white py-1 transition-colors">
                View all 10 more...
              </button>
...
function Composer({
  ...
  const [postType, setPostType] = useState<"text" | "poll" | "announcement">(
    "text",
  );
  ...
  const handleSubmit = () => {
    ...
    const post: any = {
      ...
      authorInitials: "ME",
      authorLevel: "explorer",
      authorPaid: isPaidWorld, // Add authorPaid true if user is in paid world (assumed joined and paying to post)
        ...
        <div className="p-4 flex items-center gap-3 shrink-0">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-1.5 mt-0.5">
              <span className="text-[10px] bg-[#9CA3AF]/20 border border-[#9CA3AF]/30 text-[#9CA3AF] px-1.5 py-0.5 rounded-sm font-bold">
                🗺 Explorer
              </span>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-4 flex flex-col gap-6 hide-scrollbar">
          ...
          {postType === "text" && (
            <div className="relative">
              <textarea
                ...
                placeholder={`What do you want to share with this world?`}
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <button
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg border text-[12px] font-bold transition-all bg-transparent border-white/5 text-[#888899]/50 cursor-not-allowed`}
              >
