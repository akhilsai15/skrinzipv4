      ...
      <AnimatePresence>
        ...
        {activePopover === "leave" && (
          ...
          >
            ...
            <div className="mb-6">
              <p className="text-base text-white/90">🔥 {room.title}</p>
            ...
            <p className="text-white/70 text-sm mb-6 pb-6 border-b border-white/10">
              The campfire will keep burning without you. 🔥
            </p>
...
function RoomCreationSheet() {
  const { setStatus, setUserState } = useVoiceRoomStore();
      ...
      {lighting && (
        <div className="absolute inset-0 z-50 flex items-end justify-center pb-40">
          <motion.div
            ...
            className="w-4 h-4 bg-orange-500 rounded-full shadow-[0_0_40px_20px_#ff8c00]"
          />
        </div>
      )}
      ...
      >
        ...
        <div className="space-y-6">
          <div>
            ...
            <input
              type="text"
              placeholder='e.g. "Evening Chat"'
              defaultValue="Evening Gaming Session"
              className="w-full bg-transparent border-b border-white/20 pb-2 text-white text-lg focus:outline-none focus:border-white/50 transition-colors"
            />
          ...
          <div className="border-t border-white/5 pt-6">
            ...
            <div className="space-y-3">
              <label className="flex items-center gap-3 cursor-pointer group">
                <input type="radio" name="spk" className="accent-[#ff8c00]" />
                <span className="text-white text-sm group-hover:text-[#ff8c00] transition">
                  Everyone (open room)
                </span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer group">
          ...
          <button
            ...
            className="w-full py-4 mt-4 rounded-xl text-white font-bold transition flex items-center justify-center gap-2 bg-gradient-to-r from-orange-500 to-red-500 hover:brightness-110 active:scale-[0.98] shadow-[0_0_20px_rgba(255,140,0,0.3)]"
          >
            🔥 Light the Campfire
          </button>
        </div>
...
function RoomSummary() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-16 h-16 rounded-full flex items-center justify-center text-3xl bg-white/5 border border-white/10 mb-6 drop-shadow-[0_0_15px_rgba(255,140,0,0.2)]">
          🔥
        </div>

        <h2 className="text-2xl font-bold text-white mb-2">Campfire Ended</h2>
        <p className="text-[#ff8c00] font-medium mb-1">
