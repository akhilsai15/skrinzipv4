    ...
    <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="flex flex-col h-full">
      ...
      <div className="flex flex-col gap-5 flex-1">
         ...
         <div className="mt-4">
           ...
           <PreviewCard name={data.name} desc={data.desc} activeColors={activeColors} />
         </div>
      </div>
...
function Step2Atmosphere({ data, onChange, onNext, activeColors }: any) {
  return (
    <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="flex flex-col h-full">
      ...
      <p className="text-[#888899] text-[13px] mb-8 leading-relaxed">This defines the colour and feel of your world.</p>
...
function PreviewCard({ name, desc, activeColors }: any) {
  return (
       ...
       <div className="relative z-10 p-4 flex flex-col h-full justify-between">
         <div className="flex gap-3">
            ...
            <div className="flex flex-col flex-1">
               <h4 className="text-[14px] font-bold text-white line-clamp-1">{name || "World Name"}</h4>
               <p className="text-[11px] text-white/50 line-clamp-2 mt-0.5 leading-snug">{desc || "Short description appears here..."}</p>
            </div>
         </div>
